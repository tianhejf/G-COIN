...
const QString BITCOIN_IPC_PREFIX("G-coin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click G-coin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start G-coin: click-to-pay handler");
    else
...
{
    // clicking on G-coin: URLs creates FileOpen events on the Mac:
